...
k_shots = [3,5]
target_dir = root_dir+'/Datasets/FewShot/Microscopy/'
...
extractFewShotTargetSelections.extractFewShotTargetSelection(target_dir=target_dir,num_shots=k_shots,datasets=datasets)
